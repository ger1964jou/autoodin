/*
  ...
  Last updated Jan 31, 2015 (Jonathan Forbes)
...
void setup() 
{
  ...
  pause_button_flag = 0; // Sometimes an uncaught button bounce would cause the flag to set after the pause, resulting in the sampling loop to begin paused.
...
void loop() {
  ...
  Serial.println("\n");
  // There is a problem with the Wifi card where it uses LOTS of power, currently being worked on, commenting out the next line prevents the card from powering on
  //send_data_to_server(); ////////////////////////////////////////////////////////////////////////////////////////WIFIWIFIWIFIWIFI
...
void checkPauseButton()
{
  ...
  {
    pause_button_flag = 0; // unset the pause flag now that we're handling it
